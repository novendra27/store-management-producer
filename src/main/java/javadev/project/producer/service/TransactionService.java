...
public class TransactionService {
     ...
     * @return TransactionRequest containing the same transaction data that will be sent to Kafka
     * @throws ConstraintViolationException if validation fails
     * @throws ResponseStatusException if product is not found or insufficient stock
     */
    public TransactionRequest createTransaction(TransactionRequest transactionRequest) {
        ...
        // TODO: Implementasi producer to Kafka
        // Send transactionRequest to Kafka topic
        // Example: kafkaTemplate.send("transaction-topic", transactionRequest);
